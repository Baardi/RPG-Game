...
public:
	...
	bool load(const Json::Value &layer, const std::unordered_map<int, TileSet> &tileSets, const ObjectSpriteFactory &spriteFactory);
	...
	// todo std::unordered_map<int gid, ObjectSprite *>
};
